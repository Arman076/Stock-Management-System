...
class IMS:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Inventory Managemnt System",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),fg="#010c48",bg="white",anchor="w",padx=100).place(x=0,y=0,relwidth=1,height=70)
        
        #=========================================================LOG_OUT BUTTON====================================================================================
        btn_log_out=Button(self.root,text="log out",font=("times new roman",15,"bold"),bg="yellow",cursor="hand2").place(x=1250,y=10,height=50,width=150)
        
        #=============================================================CLOCK========================================================================================
        self.lbl_clock=Label(self.root,text="Welcome Inventory Managemnt System\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new roman",15),bg="#4d636d",fg="blue",anchor="w",padx=500)
